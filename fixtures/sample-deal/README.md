# Sample deal package — Riverside Medical Plaza

A synthetic, self-consistent due-diligence package for testing. Upload these files
on the **New run** page (or paste their contents). They are engineered so the
committee surfaces both signature findings.
...
- **Cascading recalculation** — Regulatory flags the **R-3 zoning conflict** (Critical) →
  Financial re-underwrites → the IRR visibly changes.
...
Tip: uploading all five gives the richest run; the contract alone is enough to see the
